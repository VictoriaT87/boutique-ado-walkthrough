...
def cache_checkout_data(request):
    try:
        ...
        # modify metadata with user, if they saved info, JSON dump of bag
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        # get current bag total from context.py
        current_bag = bag_contents(request)
        # get grand_total key from bag in context.py
